...
async def target(inputs: dict):
    ...
    config["configurable"]["summarization_model"] = "vllm:Qwen2.5-7B-Instruct"
    config["configurable"]["summarization_model_max_tokens"] = 8192
    config["configurable"]["research_model"] = "vllm:Qwen2.5-7B-Instruct"
    config["configurable"]["research_model_max_tokens"] = 10000
    config["configurable"]["compression_model"] = "vllm:Qwen2.5-7B-Instruct"
    config["configurable"]["compression_model_max_tokens"] = 10000
    config["configurable"]["final_report_model"] = "vllm:Qwen2.5-7B-Instruct"
